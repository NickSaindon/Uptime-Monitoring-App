...
// Get the string content of a template and use provided data for the string interpolation
...
// Add the universal header and footer to a string and provide data object to the header and footer for interpolation
...
helpers.interpolate = function(str, data) {
    ...
    // Add the templateGlobals to the dat object, prepare their key name with "global"
